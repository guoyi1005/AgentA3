...
当 action=call_tool 且 tool_name 为校园数据工具（java_schedule_api、java_activity_api、java_meeting_api、java_canteen_api、java_facility_api）时，必须输出 tool_params 对象；具体字段见 leader_profile_usage_policy 中的示例。
